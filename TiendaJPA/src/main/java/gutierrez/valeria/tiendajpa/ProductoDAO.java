    ...
    */
    ...
    public void eliminar(int id){
        ...
        if (p != null) {
            ...
            System.out.println("No se pudo eliminar: El producto con ID " + id + " no existe.");
        }
    ...
    public List<Producto> listar(){
        EntityManager em = emf.createEntityManager(); // Crea el gestor
        // Usamos JPQL: se consulta a la CLASE "Producto", no a la tabla.
        List<Producto> lista = em.createQuery("SELECT p FROM Producto p", Producto.class).getResultList();
        /*
        - createQuery: Crea la instrucción de búsqueda.

        - getResultList(): Ejecuta la consulta y te devuelve una lista 
                           con todos los objetos que encontró.
        */
